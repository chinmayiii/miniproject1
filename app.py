...
# --- START: BRUTAL FORCE FIX ---
# This forces the library to use the correct, modern 'v1' API.
# It overrides the broken environment that keeps trying to use 'v1beta'.
genai.configure(transport="rest")
# --- END: BRUTAL FORCE FIX ---

# Load the secret key from the .env file
load_dotenv()
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")

# If the key is not found, print an error and exit
